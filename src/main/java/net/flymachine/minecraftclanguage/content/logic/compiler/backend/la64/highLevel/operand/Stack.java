 ...
 */
public record Stack(int offset, AsmType asmType, boolean fpRelative) implements HighLevelOperand {

    public Stack(int offset, AsmType asmType) {
        this(offset, asmType, true);
    }

    @Override
    public HighLevelOperand changeAsmType(AsmType asmType) {
        return new Stack(offset, asmType, fpRelative);
    }
}
